...
public class NCMap {
    ...
    public static void test4(Scanner in) {
        try ( PrintWriter fout4 = new PrintWriter("./inputs/output.txt") ) {
            final double dt = 1.0 / 15;//设定间隔时间
            double width = in.nextDouble();
            double height = in.nextDouble();
            Cell.setSideLength(width, height);
    ...
    public static void changeColor(KdTree tree, Cell cell){
        ...
        for(Cell i:sur){
            if(cell.getColor().equals(Color.red)){
                if(i.getColor().equals(Color.red)){
                    cnt1++;
                }
                if(i.getColor().equals(Color.yellow)){
                    cnt2++;
                }
            }
            else if(cell.getColor().equals(Color.green)){
                if(i.getColor().equals(Color.green)){
                    cnt1++;
                }
                if(i.getColor().equals(Color.red)){
                    cnt2++;
                ...
                if(i.getColor().equals(Color.blue)){
                    cnt1++;
                }
                else if(i.getColor().equals(Color.green)){
                    cnt2++;
                }
            }
                ...
                else if(i.getColor().equals(Color.blue)){
                    cnt2++;
                }
            }
            count++;
